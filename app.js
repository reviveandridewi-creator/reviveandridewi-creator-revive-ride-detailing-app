...
const firebaseConfig = {
    apiKey: "AIzaSyC7yxoY9MS3KDP7uyhW7gH6WTnIxxCE...",
    ...
    jobs.forEach((job) => {
        ...
        row.innerHTML = `
            ...
            <td>
                ...
                <span style="color: #8b949e; font-size: 0.8rem; display: block; margin-top: 4px; max-width: 250px; white-space: pre-wrap;">Notes: ${job.inspectionNotes || 'None'}</span><br>
                <span style="color: #58a6ff; font-size: 0.7rem;">Logged by: ${job.loggedBy || 'Admin'}</span>
            </td>
